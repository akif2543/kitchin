        ...
        const registerUser = () => {
            if(validateForm().length === 0) {
                ...
                .then(json=>{
                    ...
                    setGlobalState({ ...globalState, openRegistration: false, signedIn: true });
                })
                    }
        };
        ...
        <div className="registration-form container" id="signup">
            ...
            <div className="registration-flex container">
                <div className="registration-form-item form-group">
                    ...
                    <input ref={elem => (firstName = elem)} type="text" className="form-control" id="firstName" placeholder="First name" />
                </div>
                <div className="registration-form-item form-group">
                    <label>Last name</label>
                    <input ref={elem => (lastName = elem)} type="lastName" className="form-control" id="lastName" placeholder="Last name" />
                </div>
                <div className="registration-form-item form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input ref={elem => (email = elem)} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" />
                    <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
                </div>
                <div className="registration-form-item form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input ref={elem => (password = elem)}type="password" className="form-control" id="exampleInputPassword1" placeholder="Password" />
                </div>
                <div className="registration-form-item form-group form-check">
                    <input ref={elem => (termsConditions = elem)} type="checkbox" className="form-check-input" id="exampleCheck1" />
